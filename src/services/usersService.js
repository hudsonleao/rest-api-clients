...
module.exports = ({ repositories: { usersRepository }, mappers: { usersMapper } }) => {
    ...
    return {
        ...
        create: async ({ name, user, password, subject }) => {
            ...
            if (userExist) return UNPROCESSABLE_ENTITY('User already exists', 'usersService', 'create');
        ...
        getById: async (user_id) => {
            ...
            if (!users) return NOT_FOUND('User id not found', 'usersService', 'getById');
        ...
        update: async (query, user_id) => {
            ...
            if (!users) return NOT_FOUND('User id not found', 'usersService', 'update');
        ...
        delete: async (user_id) => {
            ...
            if (!users) return NOT_FOUND('User id not found', 'usersService', 'delete');
